...
def _desenhar_pdf(c, nome, texto, signature_path, bg_path, W, H, font_body, font_bold):
    """Desenha todo o conteúdo em um canvas PDF já criado."""
    # Fundo
    if bg_path is None:
...
def gerar_pdf(
    ...
    _desenhar_pdf(c, nome, texto, signature_path, bg_path, W, H, font_body, font_bold)
    c.save()
